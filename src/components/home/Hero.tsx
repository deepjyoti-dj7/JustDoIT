...
const sections = [
  {
    ...
    description:
      "CAP theorem, distributed systems, networking, databases, caching, reliability, and real-world system design.",
  ...
  },
  {
    ...
    description:
      "OOP, SOLID principles, UML diagrams, GoF design patterns, anti-patterns, and best practices.",
  ...
  },
  {
    ...
    title: "DSA",
    description:
      "Arrays, trees, graphs, dynamic programming, sorting, searching, and 150+ curated coding problems.",
    href: "/dsa",
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 pb-20 pt-16 xl:px-10">
      ...
      <p className="mb-12 max-w-xl text-lg text-zinc-500 dark:text-zinc-400">
        Everything you need to master system design and data structures &
        algorithms — in one place, no distractions.
      </p>
        ...
        {sections.map(
          ({ icon: Icon, title, description, href, accent, bg }) => (
            ...
            >
              ...
              <span
                className={`flex items-center gap-1 text-sm font-medium ${accent}`}
              >
                Explore{" "}
