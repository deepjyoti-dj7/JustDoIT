...
export function DocPage() {
  ...
  const [DocComponent, setDocComponent] = useState<ComponentType<{
  ...
  useEffect(() => {
    ...
    const blocks =
      contentRef.current.querySelectorAll<HTMLDivElement>(".mermaid-block");
  ...
  return (
    <div className="mx-auto flex max-w-screen-xl gap-8 px-6 py-8 xl:px-10">
      ...
      <article className="min-w-0 flex-1">
        ...
        <footer className="mt-8 border-t border-zinc-200 dark:border-zinc-800 pt-6 pb-2 text-center text-sm text-zinc-500 dark:text-zinc-400">
          © {new Date().getFullYear()} deepjyoti-dj7. All rights reserved.
        </footer>
      </article>
